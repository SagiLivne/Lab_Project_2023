...
namespace ORB_SLAM3 {
    ...
    public:
        GeometricCamera() 
        {  
            eigen_K << 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 1.f;
            cv_K = (cv::Mat_<float>(3, 3)
                << 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 0.f, 1.f);
        }
        GeometricCamera(const std::vector<float> &_vParameters) : mvParameters(_vParameters) 
        { 
            eigen_K << mvParameters[0], 0.f, mvParameters[2], 0.f, mvParameters[1], mvParameters[3], 0.f, 0.f, 1.f;
            cv_K = (cv::Mat_<float>(3, 3)
